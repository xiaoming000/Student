...
<body>
  ...
  <tr>
      <td  colspan="8" width="100%">
    	<div class="button" >
        	<a href="/Student/index.php/Home/Banji/add" ><div class="tianjia" ><span><img src="<?php echo IMG_URL ?>table/22.gif"/></span>添&nbsp;&nbsp;加</div></a>
        </div>
        ...
        <div class="button out"><a href="#"><div class="del"><span><img src="<?php echo IMG_URL ?>table/export.png"/></span>导出表</div></a></div>
           ...
           <!-- <a href="<?php echo U('Home/Banji/expUser');?>" ><div class="del"><span><img src="<?php echo IMG_URL ?>table/export.png"/></span>导出表</div></a>-->
       
    	 <div class="button">
            <a href="/Student/index.php/Home/Banji/excel" ><div class="del"><span><img src="<?php echo IMG_URL ?>table/import.png"/></span>导入表</div></a>
        </div>
        <div class="query" > 
        <form name="form2" id="form2" method="get" action="/Student/index.php/Home/Banji/search">
        <table class="table" >
            <tr >                            
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
          <tr>
            ...
            <td width="5%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">班主任电话</span></div></td>
            ...
            <td width="5%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">班主任账号</span></div></td>
    ...
    <form name="form1" id="form1" method="post" action="/Student/index.php/Home/Banji/delete">
           ...
           <input class="id" type="checkbox" name="id[]"  value="<?php echo ($vo["id"]); ?>" />
            ...
            <td bgcolor="#FFFFFF"><div align="center"><span ><?php echo ($vo["class_tutor_tel"]); ?></span></div></td>
            ...
            <td bgcolor="#FFFFFF"><div align="center"><span ><img src="<?php echo IMG_URL ?>table/edt.gif" width="16" height="16" />
            	<a href="/Student/index.php/Home/Banji/edit_class/class/<?php echo ($vo["class"]); ?>">编辑</a></span></div></td>
...
<div id="out">
	<h2><img src="<?php echo IMG_URL ?>images/close.png" alt="" class="close" />请选择需要导出的记录</h2>
         <form name="form_out" id="form_out" method="get" action="/Student/index.php/Home/Banji/expUser">
	<div class="info"></div>
    <div class="query_out">
            <table class="table">
            <tr >                            
                <td  class="th" width="40" align="center" >届别</td>
                <td  class="td"  align="center"><select class="select" name="year" id="year_out" onchange="getclass('/Student/index.php/Home/Banji/getclass','year_out','class_out')">
                    <option value="" select="select">选择届别</option>
                    <option value="<?php echo ($date); ?>" select="select"><?php echo ($date); ?></option>
                    <option value="<?php echo ($date-1); ?>" select="select"><?php echo ($date-1); ?></option>
                    <option value="<?php echo ($date-2); ?>" select="select"><?php echo ($date-2); ?></option>
