...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <td width="46%" valign="middle">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[测评及奖励]-[奖惩信息]-[计算机等级]
                                            </td>
                                        </tr>
                                    </table>
                                </td>
    ...
    <tr>
        <td colspan="8" width="100%">
		 ...
		 <div class="query"> 
         <form name="form2" id="form2" method="get" action="/Student/index.php/Home/Jiangcheng/search_computer">
            <table class="table">
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
                            <tr>
                                <td width="3%" height="22" background="<?php echo IMG_URL ?>table/bg.gif"
                                    bgcolor="#FFFFFF">
                                    <div align="center">
                                ...
                                <td width="7%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF">
                                    <div align="center"><span class="STYLE1">学年</span></div>
                                </td>
                                <td width="7%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF">
                                    <div align="center"><span class="STYLE1">学期</span></div>
                                </td>
                                <td width="7%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF">
                                    <div align="center"><span class="STYLE1">等级名称</span></div>
                                </td>
                                <td width="7%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF">
                                    <div align="center"><span class="STYLE1">成绩</span></div>
                                </td>
                                <td width="7%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF">
                                    <div align="center"><span class="STYLE1">准考证号</span></div>
                                </td>
                                <td colspan="3" width="15%" height="22" background="<?php echo IMG_URL ?>table/bg.gif"
                                    bgcolor="#FFFFFF" class="STYLE1">
                                    <div align="center">基本操作</div>
                                </td>
                            </tr>

                            <form name="form1" id="form1" method="post" action="/Student/index.php/Home/Jiangcheng/delete_english">
                                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <div align="center"><span><?php echo ($vo["school_year"]); ?> </span></div>
                                        </td>
                                        <td bgcolor="#FFFFFF">
                                            <div align="center"><span><?php echo ($vo["semester"]); ?></span></div>
                                        </td>
                                        <td bgcolor="#FFFFFF">
                                            <div align="center"><span><?php echo ($vo["level_name"]); ?></span></div>
                                        </td>
                                        <td bgcolor="#FFFFFF">
                                            <div align="center"><span><?php echo ($vo["score"]); ?></span></div>
                                        </td>
                                        <td bgcolor="#FFFFFF">
                                            <div align="center"><span><?php echo ($vo["admission"]); ?></span></div>
                                        </td>
                                        <td bgcolor="#FFFFFF">
                                            <div align="center"><span><img src="<?php echo IMG_URL ?>table/edt.gif"
                                                                           width="16" height="16"/><a
                                                    href="/Student/index.php/Home/Jiangcheng/edit_english/id/<?php echo ($vo["id"]); ?>">编辑</a></span></div>
                                        </td>
                                        <td bgcolor="#FFFFFF">
                                            <div align="center"><span><img src="<?php echo IMG_URL ?>table/del.gif"
                                                                           width="16" height="16"/><a
                                                    href="/Student/index.php/Home/Jiangcheng/del_english/id/<?php echo ($vo["id"]); ?>">删除</a></span></div>
                                        </td>
