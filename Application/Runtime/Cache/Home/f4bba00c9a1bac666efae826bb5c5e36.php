                ...
                <tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6"
                            ...
                            <form name="form1" id="form1" method="post" action="/Student/index.php/Home/Jiangcheng/delete_computer">
                                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <div align="center"><span><img src="<?php echo IMG_URL ?>table/edt.gif"
                                                    ...
                                                    href="/Student/index.php/Home/Jiangcheng/edit_computer/id/<?php echo ($vo["id"]); ?>">编辑</a></span></div>
                                        </td>
                                        <td bgcolor="#FFFFFF">
