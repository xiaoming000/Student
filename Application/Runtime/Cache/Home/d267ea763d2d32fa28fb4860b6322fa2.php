...
<form action="/Student/index.php/Home/Banji/edit_class/class/A1421" method="post">
...
<table width="500" border="1" cellspacing="0" cellpadding="0" bgcolor="b5d6e6">
  <tr align="center" >
      ...
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="class" value="<?php echo ($info["class"]); ?>" /></td>
   <td width="17%">班主任</td>
      <td width="" ><input type="text" name="name" value="<?php echo ($info["name"]); ?>"/></td>
  </tr>
  <tr align="center" >
      <td height="35" >专业</td>
      <td  bgcolor="#FFFFFF" ><input type="text" name="professional" value="<?php echo ($info["professional"]); ?>"/></td>
      <td >班主任电话</td>
      <td ><input type="text" name="class_tutor_tel" value="<?php echo ($info["class_tutor_tel"]); ?>"/></td>
  </tr>
  <tr align="center" >
      <td height="35">班长</td>
      <td bgcolor="#FFFFFF"><input type="text" name="monitor" value="<?php echo ($info["monitor"]); ?>"/></td>
      <td>班主任账号</td>
      <td bgcolor="#FFFFFF"><input type="text" name="number" value="<?php echo ($info["number"]); ?>"/></td>
 </tr>
  <tr align="center" >
      <td>团支书</td>
      <td><input type="text" name="league_secretary" value="<?php echo ($info["league_secretary"]); ?>"/></td>
      <td height="35">密码</td>
      <td bgcolor="#FFFFFF"><input type="text" name="password" value="<?php echo ($info["password"]); ?>"/></td>
  </tr>
  <tr align="center" >
      <td height="35">QQ群</td>
      <td bgcolor="#FFFFFF" ><input type="text" name="qqq" value="<?php echo ($info["qqq"]); ?>"/></td>
      <td>权限</td>
      <td bgcolor="#FFFFFF">
      	<select name="power">
  ...
  <tr align="center" >
      ...
      <td colspan="3" bgcolor="#FFFFFF"><input type="text" name="monitor_tel" value="<?php echo ($info["monitor_tel"]); ?>"/></td>
 </tr>
</table>
