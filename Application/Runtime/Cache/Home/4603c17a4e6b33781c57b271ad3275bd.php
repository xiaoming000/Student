...
<form action="/student/index.php/Home/Graduate/add" method="post">

<table width="500" border="1" cellspacing="0" cellpadding="0" bgcolor="b5d6e6">
  <tr align="center" >
      <td width="15%" height="35">姓名</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="s_name" value="" /></td>
   <td width="17%">学号</td>
      <td width="" ><input type="text" name="s_number" value=""/></td>
  </tr>
  <tr align="center" >
      <td height="35" >性别</td>
  ...
  <tr align="center" >
      ...
      <td height="35">QQ号</td>
      <td bgcolor="#FFFFFF"><input type="text" name="qq" value=""/></td>
  </tr>
  <tr align="center" >
      <td height="35">职务</td>
      <td bgcolor="#FFFFFF" ><input type="text" name="work_post" value=""/></td>
      <td height="35">更新时间</td>
      <td bgcolor="#FFFFFF"><input type="text" id="time" name="time" value=""/></td>
  </tr>
  <tr align="center" >
      <td height="35">就业单位</td>
      <td bgcolor="#FFFFFF"><input type="text" name="work_unit" value=""/></td>
      <td>单位性质</td>
      <td bgcolor="#FFFFFF">
          <select name="work_type" >
              <option value="机关" select="select"></option>
 ...
 <div>
   ...
   <font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*更新时间:默认为当前时间</font><br/>
 </div>
</body>
</html>