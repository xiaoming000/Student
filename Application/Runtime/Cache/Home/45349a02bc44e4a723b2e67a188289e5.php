...
<form action="/Student/index.php/Home/Fangyuan/add" method="post">
...
<table width="300" border="1" cellspacing="0" cellpadding="0" bgcolor="b5d6e6">
  <tr align="center" >
      <td width="30%" height="35">主校区</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="school" value="" /></td>
  </tr>
  <tr align="center" >
      <td width="30%" height="35">楼栋</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="building" value="" /></td>
  </tr>
  <tr align="center" >
      <td  height="35">楼层</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="floor" value="" /></td>
  </tr>
  <tr align="center" >
      <td  height="35">寝室</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="bnumber" value="" /></td>
  </tr>
  <tr align="center" >
      <td  height="35">性别</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="sex" value="" /></td>
  </tr>
  <tr align="center" >
      <td  height="35">床位数</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="max" value="" /></td>
  </tr>
  <tr align="center" >
      <td  height="35">价格</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="price" value="" /></td>
  </tr>
  <tr align="center" >
      <td  height="35">寝室长</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="boss" value="" /></td>
  </tr>
  <tr align="center" >
      <td  height="35">寝室长电话</td>
      <td width="" bgcolor="#FFFFFF" ><input type="text" name="telnumber" value="" /></td>
  </tr>
</table>
