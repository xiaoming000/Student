...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[账户管理]-[教师账户]</td>
              </tr>
            </table></td>
  ...
  <tr>
  	<td  colspan="8" width="100%">
        ...
        <div class="query" > 
        <form name="form2" id="form2" method="post" action="/Student/index.php/Home/Admin/search">
        <table class="table" >
            <tr >                            
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
          <tr>
            ...
            <td width="15%" height="22" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF" class="STYLE1"><div align="center">基本操作</div></td>
          </tr>
          <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr style="color:#444;font-size:14px;">
            <td height="35" bgcolor="#FFFFFF"><div align="center">
              <input type="checkbox" name="class[]" id="s" value="<?php echo ($vo["class"]); ?>" />
            </div></td>
            ...
            <td height="20" bgcolor="#FFFFFF"><div align="center"><?php echo ($vo["power"]); ?><span ></span></div></td>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span ><img src="<?php echo IMG_URL ?>table/edt.gif" width="16" height="16" />
            	<a href="/Student/index.php/Home/Admin/edit_teacher/class/<?php echo ($vo["class"]); ?>">编辑</a></span></div></td>
