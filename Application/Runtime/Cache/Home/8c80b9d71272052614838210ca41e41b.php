 ...
 <table  width="100%" border="0" cellspacing="0" cellpadding="0" >
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[资助信息]-[资助记录]</td>
              </tr>
            </table></td>
  ...
  <tr>
  	<td  colspan="8" width="100%">
    	<div class="button" >
        	<a href="/Student/index.php/Home/Subsidy/add" ><div class="tianjia" ><span><img src="<?php echo IMG_URL ?>table/22.gif"/></span>添&nbsp;&nbsp;加</div></a>
        </div>
        ...
        <div class="button">
            <a href="/Student/index.php/Home/Subsidy/in" ><div class="del"><span><img src="<?php echo IMG_URL ?>table/import.png"/></span>导入表</div></a>
        </div>
		<div class="right"> 
        <form name="form2" id="form2" method="post" action="/Student/index.php/Home/Subsidy/search">
        <table class="table" >
            <tr>
                ...
                <td  class="td"  align="center"><select class="select" name="school_year">
					...
					<option value="<?php echo ($date-2); ?>-<?php echo ($date-1); ?>"><?php echo ($date-2); ?>-<?php echo ($date-1); ?></option>
					<option value="<?php echo ($date-3); ?>-<?php echo ($date-2); ?>"><?php echo ($date-3); ?>-<?php echo ($date-2); ?></option>
                </select></td>

				<td  class="th" width="40" align="center" >年级</td>
                <td  class="td"  align="center"><select class="select" id="grade" name="grade" onchange="getclass('/Student/index.php/Home/Subsidy/getclass','grade','class')">
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" >
          <tr>
            ...
            <td width="10%" height="22" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">学号</span></div></td>
            <td width="10%" height="22" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">姓名</span></div></td>
            <td width="8%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">性别</span></div></td>
            <td width="14%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">专业</span></div></td>
			<td width="8%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">班级</span></div></td>
			<td width="10%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">资助类型</span></div></td>
			<td width="10%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">资助金额</span></div></td>
			<td width="10%" background="<?php echo IMG_URL ?>table/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">年度</span></div></td>
...
<form id="form1" name="form1" method="get" action="/Student/index.php/Home/Subsidy/del" >    
          <?php if(is_array($sub)): $k = 0; $__LIST__ = $sub;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr >
			...
			<td height="20" bgcolor="#FFFFFF"><div align="center"><span ><?php echo ($vo["sex"]); ?></span></div></td>
            ...
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span ><?php echo ($vo["type"]); ?> </span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span ><?php echo ($vo["money"]); ?></span></div></td>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span ><?php echo ($vo["time"]); ?></span></div></td>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span ><img src="<?php echo IMG_URL ?>table/edt.gif" width="16" height="16" />
            	<a href="/Student/index.php/Home/Subsidy/edit/id/<?php echo ($vo["id"]); ?>">编辑</a></span></div></td>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span ><img src="<?php echo IMG_URL ?>table/del.gif" width="16" height="16" />
            <a href="#" class="del1"  del_href="/Student/index.php/Home/Subsidy/del/id/<?php echo ($vo["id"]); ?>">删除</a></span></div></td>
...
<div id="out">
  ...
  <form name="form_out" id="form_out" method="get" action="/Student/index.php/Home/Subsidy/out">
	<div class="info"></div>
    <div class="query_out" style="padding:0px 40px 10px 125px;">
        <table class="table" >
            <tr>
                <td  class="th" width="40" align="center" >学年</td>
                <td  class="td"  align="center"><select class="select" name="school_year">
			...
			<tr>
				<td  class="th" width="40" align="center" >年级</td>
                <td  class="td"  align="center"><select class="select" id="grade2" name="grade2" onchange="getclass('/Student/index.php/Home/Subsidy/getclass','grade2','class2')">
